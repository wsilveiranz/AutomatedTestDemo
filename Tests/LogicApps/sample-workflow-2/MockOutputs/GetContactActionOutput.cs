...
{
    /// <summary>
    /// The <see cref="GetContactActionMock"/> class.
    /// </summary>
    public class GetContactActionMock : ActionMock
    {
        /// <summary>
        /// Creates a mocked instance for  <see cref="GetContactActionMock"/> with static outputs.
        /// </summary>
        public GetContactActionMock(TestWorkflowStatus status = TestWorkflowStatus.Succeeded, string name = null, GetContactActionOutput outputs = null)
            : base(status: status, name: name, outputs: outputs ?? new GetContactActionOutput())
        {
        }

        /// <summary>
        /// Creates a mocked instance for  <see cref="GetContactActionMock"/> with static error info.
        /// </summary>
        public GetContactActionMock(TestWorkflowStatus status, string name = null, TestErrorInfo error = null)
            : base(status: status, name: name, error: error)
        {
        }

        /// <summary>
        /// Creates a mocked instance for <see cref="GetContactActionMock"/> with a callback function for dynamic outputs.
        /// </summary>
        public GetContactActionMock(Func<TestExecutionContext, GetContactActionMock> onGetActionMock, string name = null)
    ...
    /// <summary>
    /// Class for GetContactActionOutput representing an object with properties.
    /// </summary>
    public class GetContactActionOutput : MockOutput
    {
        /// <summary>
        /// [object Object]
        /// </summary>
        public GetContactActionOutputBody Body { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactActionOutput"/> class.
        /// </summary>
        public GetContactActionOutput()
        {
            this.StatusCode = HttpStatusCode.OK;
            this.Body = new GetContactActionOutputBody();
        }
    ...
    /// [object Object]
    /// </summary>
    public class GetContactActionOutputBody
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty(PropertyName="_parentcustomerid_value@Microsoft.Dynamics.CRM.lookuplogicalname")]
        ...
        /// </summary>
        [JsonProperty(PropertyName="_accountid_value@Microsoft.Dynamics.CRM.lookuplogicalname")]
        ...
        /// </summary>
        [JsonProperty(PropertyName="_parentcontactid_value@Microsoft.Dynamics.CRM.lookuplogicalname")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactActionOutputBody"/> class.
        /// </summary>
        public GetContactActionOutputBody()
        {
